...
<html lang="es">
  ...
  <head>
    ...
    <!-- Favicons-->
    <link href="{{ asset('plantilla/images/favicon/apple-touch-icon-152x152.png') }}" rel="apple-touch-icon-precomposed">
    <!-- For iPhone -->
    ...
    <link href="{{ asset('plantilla/vendors/flag-icon/css/flag-icon.min.css') }}" type="text/css" rel="stylesheet">
  ...
  <body>
              ...
              <li>
                <h1 class="logo-wrapper">
                  <a href="index.html" class="brand-logo darken-1">
                    <img src="{{ asset('plantilla/images/logo/materialize-logo.png') }}" alt="materialize logo">
              ...
              <li>
                <a href="javascript:void(0);" class="waves-effect waves-block waves-light profile-button" data-activates="profile-dropdown">
                  <span class="avatar-status avatar-online">
                    <img src="{{ asset('plantilla/images/avatar/avatar-7.png') }}" alt="avatar">
                    <i></i>
                  </span>
                </a>
              </li>
            ...
            <li class="user-details cyan darken-2">
              <div class="row">
                <div class="col col s4 m4 l4">
                  <img src="{{ asset('plantilla/images/avatar/avatar-7.png') }}" alt="" class="circle responsive-img valign profile-image cyan">
                </div>
                <div class="col col s8 m8 l8">
                  ...
                  @php
                    ...
                    FROM
                      users
                      INNER JOIN personas
                      INNER JOIN roles ON personas.rol_id = roles.id
                  ...
                  <p class="user-roal">{{ $usuario[0]->nombreRol }}</p>
                </div>
              </div>
            </li>
            <li class="no-padding">
              <ul class="collapsible" data-collapsible="accordion">
                ...
                <li class="bold">
                  <a href="{{ route('roles.index') }}" class="waves-effect waves-cyan">
                    <i class="material-icons">lightbulb_outline</i>
                ...
                <div id="chatapp" class="col s12">
                  <div class="collection border-none">
                    <a href="#!" class="collection-item avatar border-none">
                      <img src="{{ asset('plantilla/images/avatar/avatar-1.png') }}" alt="" class="circle cyan">
                    ...
                    <a href="#!" class="collection-item avatar border-none">
                      <img src="{{ asset('plantilla/images/avatar/avatar-2.png') }}" alt="" class="circle deep-orange accent-2">
                    ...
                    <a href="#!" class="collection-item avatar border-none">
                      <img src="{{ asset('plantilla/images/avatar/avatar-3.png') }}" alt="" class="circle teal accent-4">
                    ...
                    <a href="#!" class="collection-item avatar border-none">
                      <img src="{{ asset('plantilla/images/avatar/avatar-4.png') }}" alt="" class="circle cyan">
                      <span class="line-height-0">June Lane </span>
                      <span class="medium-small right blue-grey-text text-lighten-3">4.14 AM</span>
                      <p class="medium-small blue-grey-text text-lighten-3">Ohh God </p>
                    </a>
                    <a href="#!" class="collection-item avatar border-none">
                      <img src="{{ asset('plantilla/images/avatar/avatar-5.png') }}" alt="" class="circle red accent-2">
                    ...
                    <a href="#!" class="collection-item avatar border-none">
                      <img src="{{ asset('plantilla/images/avatar/avatar-6.png') }}" alt="" class="circle deep-orange accent-2">
                    ...
                    <a href="#!" class="collection-item avatar border-none">
                      <img src="{{ asset('plantilla/images/avatar/avatar-7.png') }}" alt="" class="circle cyan">
                    ...
                    <a href="#!" class="collection-item avatar border-none">
                      <img src="{{ asset('plantilla/images/avatar/avatar-8.png') }}" alt="" class="circle red accent-2">
                    ...
                    <a href="#!" class="collection-item avatar border-none">
                      <img src="{{ asset('plantilla/images/avatar/avatar-9.png') }}" alt="" class="circle teal accent-4">
                    ...
                    <a href="#!" class="collection-item avatar border-none">
                      <img src="{{ asset('plantilla/images/avatar/avatar-2.png') }}" alt="" class="circle red accent-2">
                    ...
                    <a href="#!" class="collection-item avatar border-none">
                      <img src="{{ asset('plantilla/images/avatar/avatar-4.png') }}" alt="" class="circle red accent-2">
                    ...
                    <a href="#!" class="collection-item avatar border-none">
                      <img src="{{ asset('plantilla/images/avatar/avatar-5.png') }}" alt="" class="circle cyan">
    ...
    <script type="text/javascript" src="{{ asset('plantilla/js/custom-script.js') }}"></script>
